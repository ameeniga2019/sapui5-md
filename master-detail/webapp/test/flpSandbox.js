		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#MasterDetailApp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MasterDetailApp-display": {
								"semanticObject": "MasterDetailApp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5.md.masterdetail",
									"url": sap.ui.require.toUrl("sapui5/md/masterdetail")
								}
							}
						}
					}
